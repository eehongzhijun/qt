...
PortManager::PortManager(QToolBar *toolbar, QAction *portSetAction)
{
    ...
    qDebug() << "portFactory:" << m_portFactorys;
    qDebug() << "toolbar:" << toolbar << "\r\nportSetAction:" << portSetAction;

    m_toolbar = toolbar;
    m_portSetAction = portSetAction;

//    SerialPortFactory *tmp = new SerialPortFactory;
//    m_portFactorys->append(tmp);
...
//    m_portFactorys->at(0)->create(toolbar);
